        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(320px, 100%), 1fr))', gap: 32 }} className="lg:grid-cols-3">
              ...
              <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <div style={{ fontSize: 13, color: 'var(--brand-2)', fontWeight: 600, marginTop: 2 }}>
                    Deputado Federal {presidente.uf} · {presidente.partido_sigla}
                  </div>
                  
                  <p style={{ fontSize: 13, color: 'var(--ink-3)', lineHeight: 1.5, margin: '12px 0 0' }}>
                    Como presidente da Câmara dos Deputados, Hugo Motta representa a Casa, define a pauta de votações de projetos em plenário, e conduz as sessões legislativas da Mesa Diretora do Congresso.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-3)', lineHeight: 1.5, margin: '0 0 16px' }}>
              Criada pela Constituição Imperial de 1824, a Câmara dos Deputados representa a soberania do povo brasileiro.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {proposicoes.length > 0 ? proposicoes.map((prop, idx) => {
                ...
                [
                  ...
                  { label: 'DADOS ABERTOS', cor: '#F59E0B', icon: '🔓', title: 'API Dados Abertos da Câmara', sub: 'dadosabertos.camara.leg.br' },
                ].map((item, idx) => (
                  <div key={idx} style={{
                    padding: '14px 16px',
                    background: 'var(--panel)',
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: 'var(--ink-3)', marginTop: 2 }}>
                        Média de gastos da cota CEAP por deputado.
                      </div>
                    </div>
                  </div>
                </Link>
                        ...
                        <div style={{
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--ink-3)', fontFamily: 'var(--font-mono)' }}>
                              ...
                              <span style={{ color: 'var(--accent-gold)' }}>CEAP: {p.total_gasto != null ? fmtMoeda(p.total_gasto) : '—'}</span>
                            </div>
                          </div>
                        </div>
                      </Link>
      ...
      <section style={{ borderTop: '1px solid var(--line)', background: 'var(--panel)', padding: '56px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          ...
          <div style={{ marginTop: 32, display: 'flex', justifyContent: 'center' }}>
            ...
            className="hover-card">
              Ver todas as 30 Comissões da Câmara →
            </Link>
          </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 32 }} className="md:grid-cols-3">
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: 'var(--ink-3)', lineHeight: 1.5, margin: 0 }}>
                <strong>Disque-Câmara:</strong> 0800-0-619-619 (gratuito)<br />
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: 'var(--ink-3)', lineHeight: 1.5, margin: '0 0 12px' }}>
                Para visitas guiadas, audiências públicas ou petições, consulte os canais de transparência da Câmara.
              </p>
